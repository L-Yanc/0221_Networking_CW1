...
inline constexpr int RADIO_HZ               = 1;        // 4 Hz
...
inline constexpr uint32_t NEIGHBOUR_TIMEOUT_MS = 20000;  // 20 seconds before stale
...
// ------------------------------------------------------------
inline constexpr int ENABLE_ATTACK_NONE        = 0;
inline constexpr int ENABLE_ATTACK_REPLAY      = 0;
inline constexpr int ENABLE_ATTACK_GHOST       = 0;
inline constexpr int ENABLE_ATTACK_FALSEDATA   = 0;
inline constexpr int ENABLE_ATTACK_FASTTX      = 0;
inline constexpr int ENABLE_ATTACK_INVALIDCMAC = 1;
